(() => {
  // Keep the portfolio navigation permanently visible while scrolling and stack section headings vertically.
  const navStyle = document.createElement('style');
  navStyle.textContent = `header { position: fixed !important; top: 0; left: 0; right: 0; width: 100%; z-index: 1000; }
